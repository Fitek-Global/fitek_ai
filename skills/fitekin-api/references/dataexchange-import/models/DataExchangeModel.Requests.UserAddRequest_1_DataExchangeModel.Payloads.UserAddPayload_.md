# DataExchangeModel.Requests.UserAddRequest`1[DataExchangeModel.Payloads.UserAddPayload]

| Property | Type | Nullable | Notes |
|---|---|---|---|
| `queryParams` | [DataExchangeModel.General.CommonQueryParams](DataExchangeModel.General.CommonQueryParams.md) | no |  |
| `payload` | [DataExchangeModel.Payloads.UserAddPayload](DataExchangeModel.Payloads.UserAddPayload.md) | no | required |
...
- POST /User (request) — [Import](../endpoints/Import.md)
